...
def solve_day9puzzle2():
    with open("day9_data.txt", 'r') as f:
        ...
        program, instruction_code_index, not_finished, output_queue = intcode.run()
        return output_queue[0]


def tests_day9puzzle2():
    return True


def main():
    if tests_day9puzzle2():
        print("Day 9 Puzzle 2 answer: ", solve_day9puzzle2())
